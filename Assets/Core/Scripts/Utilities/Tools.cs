...
namespace Tumbleweed.Core.Utilities
{
    ...
    public class Tools : MonoBehaviour
    {
        ...
        public static Transform CreatePrimitiveRed(Vector3 pos, string name = "sphere1", PrimitiveType type = PrimitiveType.Sphere, float size = 0.1f)
        {
        ...
        public static Transform CreatePrimitiveGreen(Vector3 pos, string name = "sphere1", PrimitiveType type = PrimitiveType.Sphere, float size = 0.1f)
        {
            var primitive = GameObject.CreatePrimitive(type).transform;
            primitive.position = pos;
            primitive.localScale = Vector3.one * size;
