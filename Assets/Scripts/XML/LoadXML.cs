...
public class LoadXML : MonoBehaviour
{
    ...
    void Start()
    {
            ...
            // TextsData
            XMLTextsData = CreateTextAssetFromXML(XMLDataPath + "/ENTextsData.xml");

            // CharacterData
            XMLMayorMaleCharacterData = CreateTextAssetFromXML(XMLDataPath + "/MayorMaleData.xml");
            XMLSettlerMaleCharacterData = CreateTextAssetFromXML(XMLDataPath + "/SettlerMaleData.xml");
            XMLSettlerFemaleCharacterData = CreateTextAssetFromXML(XMLDataPath + "/SettlerFemaleData.xml");

            // BuildingData
            XMLTentBuildingData = CreateTextAssetFromXML(XMLDataPath + "/TentData.xml");
        ...
        public TextAsset CreateTextAssetFromXML(string path)
        {
        ...
        public XmlDocument ParseXMLFile(string XMLData)
        {
